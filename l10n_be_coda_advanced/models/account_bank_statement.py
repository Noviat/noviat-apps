...
class AccountBankStatement(models.Model):
    ...
    coda_id = fields.Many2one(comodel_name="account.coda", string="CODA Data File")
    coda_note = fields.Text("CODA Notes")
    coda_bank_account_id = fields.Many2one(comodel_name="coda.bank.account")
    ...
    def button_confirm_bank(self):
        ...
        coda_statements = coda_statements.filtered(lambda r: r.state == "open")
