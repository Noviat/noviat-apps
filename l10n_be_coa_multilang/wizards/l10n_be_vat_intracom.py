...
class L10nBeVatIntracomClient(models.TransientModel):
    ...
    code = fields.Selection(
        selection=[("L", "L"), ("S", "S"), ("T", "T")], readonly=True
    )
    amount = fields.Monetary(currency_field="currency_id", readonly=True)
    currency_id = fields.Many2one(related="intracom_id.currency_id", readonly=True)
        ...
        return [
            {
                ...
                "title": _("Intracom VAT Declaration"),
