...
class L10nBeVatListingXlsx(models.AbstractModel):
        ...
        return [
            {
                ...
                "title": _("Annual Listing of VAT subjected Customers"),
    ...
    def _listing_info(self, ws, row_pos, ws_params, data, listing):
        ...
        row_pos += 1
        ws.write_string(row_pos, 1, _("Year") + ":", FORMATS["format_left_bold"])
        ...
        ws.write_string(
            row_pos,
            2,
            listing.target_move == "all" and _("All Entries") or _("Posted Entries"),
        )
        return row_pos + 2
