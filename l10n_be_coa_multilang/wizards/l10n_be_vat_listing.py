...
class L10nBeVatListingClient(models.TransientModel):
    ...
    vat = fields.Char(string="VAT Number", readonly=True)
    base_amount = fields.Monetary(currency_field="currency_id", readonly=True)
    vat_amount = fields.Monetary(
        string="VAT Amount", currency_field="currency_id", readonly=True
    )
    currency_id = fields.Many2one(related="listing_id.currency_id", readonly=True)
